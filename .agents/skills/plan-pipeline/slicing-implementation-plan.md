...
**Expected file:** `.agents/skills/plan-pipeline/SKILL.md`
...
**Expected file:** `.agents/skills/research/SKILL.md`
...
**Expected file:** `.agents/skills/plan-context/SKILL.md`
...
**Expected file:** `.agents/skills/plan-validate/SKILL.md`
...
**Expected file:** `.agents/skills/plan-build/SKILL.md`
...
**Expected file:** `.agents/skills/plan-resolve/SKILL.md`
...
**Expected file:** `.agents/skills/implement/SKILL.md`
...
**Expected file:** `.agents/skills/screen-inventory/SKILL.md`
...
**Expected files:** `.agents/skills/agents-as-skills/phases-reader.md`, `.agents/skills/agents-as-skills/decisions-reader.md`, `.agents/skills/agents-as-skills/decisions-detail-reader.md`, `.agents/skills/agents-as-skills/decisions-correlator.md`, `.agents/skills/agents-as-skills/inventory-digest-reader.md` (5 agents; plan-reader is the only one unchanged).
...
- 8 updated `SKILL.md` files under `.agents/skills/`.
- 5 updated agent definitions under `.agents/skills/agents-as-skills/` (phases-reader, decisions-reader, decisions-detail-reader, decisions-correlator, inventory-digest-reader; plan-reader unchanged).
